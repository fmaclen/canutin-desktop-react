...
const RadioGroupContainer = styled.ul`${radioGroupContainer}`;
const InputContainer = styled.li`${inputContainer}`;
const InputRadio = styled.input<any>`${inputRadio}`;
...
const RadioGroupField = ({ label, name, values, onSelectOption, register, required = false }: RadioGroupFieldProps) => (
